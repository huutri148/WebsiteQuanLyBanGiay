...
function AccountInfo(props) {
  ...
  useEffect(() => {
    if (userInfo) {
      ...
      setUserPhone(userInfo.SDT);
      setUserAvt(userInfo.Avatar);
      setUserAddress(userInfo.DiaChi);
        ...
        <div className="accountinfo-menu">
          <div className="accountinfo-avt flex">
            <img
              ...
              height="48px"
            ></img>
            <div className="accountinfo-avt-name">{userInfo.TenNguoiDung}</div>
          </div>
                ...
                <tbody>
                  ...
                  {orderList.reverse().map((item, index) => {
                    ...
                    for (let i in item.orderList) {
                      totalItem += item.orderList[i].SoLuongDat;
                    }
                    return (
